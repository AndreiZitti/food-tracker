...
export default function ProgressPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-4">
      <h1 className="text-2xl font-bold text-slate-900 mb-4">Progress</h1>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-xl shadow-sm p-4">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Calories</h2>
          <CalorieChart data={calorieData} timeRange={timeRange} loading={loading} />
        </div>

        <div className="bg-white rounded-xl shadow-sm p-4">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Weight</h2>
          <WeightChart data={weightData} timeRange={timeRange} loading={loading} />
        </div>

        <div className="bg-white rounded-xl shadow-sm p-4">
          <h2 className="text-lg font-semibold text-slate-900 mb-4">Log Weight</h2>
